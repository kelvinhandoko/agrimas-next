...
const GeneralLedgerAccountInput = () => {
      ...
      <Popover modal open={isActive} onOpenChange={setIsActive}>
        <PopoverTrigger asChild>
          <Button
            ...
            role="combobox"
            className={cn(
              "w-72 justify-between bg-transparent transition-colors hover:bg-accent/50",
                          ...
                          <React.Fragment key={groupName}>
                            ...
                            {accounts.map((account) => (
                              <CommandItem
                                ...
                                onSelect={() => {
                                  router.replace(
                                    `${paths.accountant.generalLedger}/${account.id}`,
                                  );
                                  setIsActive(false);
                                }}
...
export default GeneralLedgerAccountInput;
