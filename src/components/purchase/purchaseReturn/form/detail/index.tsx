...
import ProductInput from "@/components/purchase/purchaseReturn/form/detail/ProductInput";
import PurchaseReturnDetailCalculateTotal from "@/components/purchase/purchaseReturn/form/detail/calculatedTotal";
...
interface PurchaseReturnDetailFormProps {
  form: UseFormReturn<PurchaseReturnPayload>;
  isFormLoading: boolean;
}

const PurchaseReturnDetailForm: FC<PurchaseReturnDetailFormProps> = ({
  form,
  isFormLoading,
}) => {
          ...
          <>
            {fields.map((field, index) => (
              <TableRow key={field.uid}>
                ...
                <TableCell>
                  <PurchaseReturnDetailCalculateTotal
                    form={form}
                    index={index}
                  />
                </TableCell>
...
export default PurchaseReturnDetailForm;
