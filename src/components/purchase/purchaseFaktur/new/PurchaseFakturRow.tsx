...
import PurchaseFakturSummaryForm from "./PurchaseFakturSummaryForm";

interface PurchaseOrderRowProps {
  control: Control<PurchasePayload>;
  setValue: UseFormSetValue<PurchasePayload>;
  watch: UseFormWatch<PurchasePayload>;
}

const PurchaseFakturRow = ({
  control,
  setValue,
  watch,
...
export default PurchaseFakturRow;
