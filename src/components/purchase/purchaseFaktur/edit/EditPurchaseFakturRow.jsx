...
import EditPurchaseFakturSummaryForm from "./EditPurchaseFakturSummaryForm";

const EditPurchaseFakturRow = ({ control, setValue, watch }) => {
  ...
  const handleSelectProduct = (productId, averagePrice, index) => {
...
export default EditPurchaseFakturRow;
