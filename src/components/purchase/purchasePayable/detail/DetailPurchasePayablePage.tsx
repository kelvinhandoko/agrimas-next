...
import { TableDetailPurchasePayable } from "./TableDetailPurchasePayable";

interface DetailPurchasePayableProps {
  id: string;
}

const DetailPurchasePayablePage = ({ id }: DetailPurchasePayableProps) => {
  return (
    <Box>
      <Box className="mb-8">
        <BackButton path={paths.purchase.purchasePayable.root} />
      </Box>
          ...
          <Card className="px-6 py-4">
            <CardContent>
              <Box className="flex justify-end">
                <Badge variant="error">Belum Lunas</Badge>
              </Box>
...
export default DetailPurchasePayablePage;
