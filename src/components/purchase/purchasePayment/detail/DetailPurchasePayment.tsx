...
import { TableDetailPurchasePayment } from "./TableDetailPurchasePayment";

interface DetailPurchasePaymentProps {
  id: string;
}

const DetailPurchasePayment = ({ id }: DetailPurchasePaymentProps) => {
  return (
    <Box>
      <Box className="mb-8">
...
export default DetailPurchasePayment;
